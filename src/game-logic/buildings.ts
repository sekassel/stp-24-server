...
export const BUILDINGS = {
  ...
  power_plant: {
    id: 'power_plant',
    cost: { // TODO cheap_buildings, improved_production, efficient_resources tech trees
  ...
  mine: { // TODO cheap_buildings, efficient_buildings, improved_production tech trees
    id: 'mine',
    cost: {
  ...
  farm: { // TODO cheap_buildings, efficient_buildings, improved_production tech trees
    id: 'farm',
    cost: {
  ...
  research_lab: { // TODO cheap_buildings, efficient_buildings, improved_production tech trees
    id: 'research_lab',
    cost: {
  ...
  foundry: { // TODO cheap_buildings, efficient_buildings, improved_production tech trees
    id: 'foundry',
    cost: {
  ...
  refinery: { // TODO cheap_buildings, efficient_buildings, improved_production tech trees
    id: 'refinery',
    cost: {
